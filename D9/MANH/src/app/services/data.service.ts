...
export class DataService {
  public listItem : Array<Item> = [
    {name: "Ore no Yubi de Midarero",imageURL:'../../../assets/Ore-no-Yubi-de-Midarero-Heitengo-Futarikiri-no-Salon-de.jpg',price:1000, description:"Picante Circus, Suiseisha",quantity:0},
