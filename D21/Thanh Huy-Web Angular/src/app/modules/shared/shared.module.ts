...
@NgModule({
  ...
  exports:[ListItemComponent,BodyComponent,ItemComponent,CounterComponent,
     MatIconModule, MatButtonModule,MatTooltipModule,MatFormFieldModule,MatInputModule,ReactiveFormsModule],
})
